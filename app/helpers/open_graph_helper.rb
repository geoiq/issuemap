module OpenGraphHelper
  ...
  def og_title_tag(default = nil)
    content = @content_for_og_title || default
  ...
  def og_type_tag(default = nil)
    content = @content_for_og_type || default
  ...
  def og_url_tag(default = nil)
    content = @content_for_og_url || default
  ...
  def og_image_tag(default = nil)
    content = @content_for_og_image || default
  ...
  def og_site_name_tag(default = nil)
    content = @content_for_og_site_name || default
  ...
  def og_description_tag(default = nil)
    content = @content_for_og_description || default
